...
class Manager():
    ...
    def register_defaults(self):
        ...
        self.register('apps.week_clock.WeekClockApp', True, no_except=True)
        ...
        self.register('apps.alarm.AlarmApp', no_except=True)
        self.register('apps.timer.TimerApp', no_except=True)
        self.register('apps.musicplayer.MusicPlayerApp', no_except=True)
        self.register('apps.flashlight.TorchApp', no_except=True)
